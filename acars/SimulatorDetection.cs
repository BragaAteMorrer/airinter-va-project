...
public static class SimulatorDetector
{
    ...
    public static IReadOnlyList<DetectedSimulator> Detect(IEnumerable<string> processNames)
    {
        ...
        Add(result, names, ["prepar3d"], SimulatorKind.Prepar3D, "Prepar3D", true, false);
        Add(result, names, ["fsx"], SimulatorKind.FlightSimulatorX, "Microsoft Flight Simulator X / Steam Edition", true, false);
        Add(result, names, ["fs9"], SimulatorKind.FlightSimulator2004, "Microsoft Flight Simulator 2004", true, false);
        Add(result, names, ["x-plane", "x-plane-64", "xplane"], SimulatorKind.XPlane, "X-Plane 11/12", true, true);
        return result;
    }
