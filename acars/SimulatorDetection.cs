...
public static class SimulatorDetector
{
    ...
    public static IReadOnlyList<DetectedSimulator> Detect(IEnumerable<string> processNames)
    {
        ...
        Add(result, names, ["prepar3d", "prepar3d_v2", "prepar3d_v3", "prepar3d_v4", "prepar3d_v5", "prepar3d_v6"], SimulatorKind.Prepar3D, "Prepar3D", true, true);
        Add(result, names, ["fsx", "fsx_se"], SimulatorKind.FlightSimulatorX, "Microsoft Flight Simulator X / Steam Edition", true, true);
        Add(result, names, ["fs9"], SimulatorKind.FlightSimulator2004, "Microsoft Flight Simulator 2004", true, true);
