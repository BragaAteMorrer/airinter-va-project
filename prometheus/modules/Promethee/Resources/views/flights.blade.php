...
(()=>{
  ...
  if(Number.isFinite(previousScroll)&&previousScroll>0){requestAnimationFrame(()=>window.scrollTo({top:previousScroll,left:0,behavior:'instant'}));sessionStorage.removeItem(scrollKey);}
})();
</script>
