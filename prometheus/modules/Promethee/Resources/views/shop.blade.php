...
@section('content')
<div class="ops-header compact"><div><span class="eyebrow">BOUTIQUE PILOTE</span><h1>Boutique virtuelle.</h1><p>Chaque achat est débité du journal phpVMS du pilote.</p></div><span class="tag">Solde : {{ $wallet }}</span></div>
