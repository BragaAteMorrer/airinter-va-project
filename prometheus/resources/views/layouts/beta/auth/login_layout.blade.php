...
<head>
    ...
    <script>window.prometheeLoginI18n=@json(['minitelLocked' => __('promethee_javascript.minitel.login_locked'), 'minitelOpen' => __('promethee_javascript.minitel.login_open')]);</script>
