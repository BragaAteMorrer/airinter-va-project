...
return [
    ...
    'custom' => [
        'airline_id' => [
            ...
            'exists'   => 'Cette compagnie n\'existe pas',
        ],
        'aircraft_id' => [
            'required' => 'Un avion est requis',
            'exists'   => 'Cet avion n\'existe pas',
        ],
        'arr_airport_id' => [
            'required' => 'Un aéroport d\'arrivée est requis',
        ],
        'dpt_airport_id' => [
            'required' => 'Un aéroport de départ est requis',
        ],
        'flight_time' => [
        ...
        'source_name' => [
            'required' => 'La source du PIREP est requise',
        ],
