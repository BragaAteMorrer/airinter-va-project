  ...
  <script>
    ...
    function setEditable() {
      ...
      $('#airport-expenses a.text').editable({
        emptytext: '0',
        url: '<?php echo e(url('/admin/airports/'.$airport->id.'/expenses')); ?>',
    ...
    $(document).ready(function () {
      ...
      $('#airports-table a.inline').editable({
        ...
        mode: 'inline',
        emptytext: '0',
        url: '<?php echo e(url('/admin/airports/fuel')); ?>',
...
<?php /**PATH /home/jewe0363/prometheus/resources/views/admin/airports/script.blade.php ENDPATH**/ ?>