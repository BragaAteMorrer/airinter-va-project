<?php if(isset($leaflet_css)): ?>
    <link rel="stylesheet" href="<?php echo e($leaflet_css); ?>">
<?php endif; ?>
<div class="row">
    <div class="col-md-12">
        <div class="box-body">
...
<?php $__env->startSection('scripts'); ?>
    ...
    document.addEventListener('DOMContentLoaded', () => {
        const pilotCountries = <?php echo json_encode($countries ?? [], 15, 512) ?>;
        const visitedAirports = <?php echo json_encode($airports ?? [], 15, 512) ?>;
        const countryData = <?php echo json_encode($countryData ?? [], 15, 512) ?>;
        const providerName = 'CartoDB.Positron';
        const geoJsonUrl = '<?php echo e(asset('sppassport/custom.geo.json')); ?>';
            ...
            .then(data => {
                L.geoJson(data, {
                    ...
                    onEachFeature: (feature, layer) => {
                        ...
                        const visited = pilotCountries.includes(iso);
                        const flagUrl = `<?php echo e(asset('sppassport/flags')); ?>/${isoLower}.svg`;
        ...
        const starIcon = L.icon({
            iconUrl: "<?php echo e(asset('sppassport/airport_marker.png')); ?>",
            iconSize: [24, 33],
            iconAnchor: [12, 16],
            popupAnchor: [0, -16],
        });
...
<?php $__env->stopSection(); ?><?php /**PATH /home/jewe0363/prometheus/modules/SPPassport/Providers/../Resources/views/map.blade.php ENDPATH**/ ?>