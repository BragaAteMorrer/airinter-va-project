   ...
   <table id="users-table" class="table table-striped table-hover">
      <thead>
         <tr>
            ...
            <?php endif; ?>
            <th class="text-end"><?php echo \Kyslik\ColumnSortable\SortableLink::render(array ('awards_count', __('sptheme.awards')));?></th>
            <th class="text-end"><?php echo \Kyslik\ColumnSortable\SortableLink::render(array ('flight_time', trans_choice('common.hour', 2)));?></th>
      ...
      <tbody>
         ...
         <tr class="align-middle">
            ...
            <?php if(Auth::check()): ?>
            <td class="text-center">
               <?php $vatsim_id = optional($user->fields->firstWhere('name', $sp_settings['fieldvatsim']))->value; ?>
               <?php $ivao_id = optional($user->fields->firstWhere('name', $sp_settings['fieldivao']))->value; ?>
               <?php if($vatsim_id): ?>
               <a href="https://stats.vatsim.net/search_id.php?id=<?php echo e($vatsim_id); ?>" target="_blank" title="<?php echo app('translator')->get('sptheme.open'); ?> VATSIM <?php echo app('translator')->get('sptheme.statistics'); ?>" class="tooltiptop mx-1"><img src="<?php echo e(public_asset('/SPTheme/images/vatsim-logo-xs.png')); ?>" alt="VATSIM <?php echo app('translator')->get('sptheme.logo'); ?>" width="30" height="30"></a>
               <?php endif; ?>
               <?php if($ivao_id): ?>
               <a href="https://www.ivao.aero/member.aspx?id=<?php echo e($ivao_id); ?>" target="_blank" title="<?php echo app('translator')->get('sptheme.open'); ?> IVAO <?php echo app('translator')->get('sptheme.statistics'); ?>" class="tooltiptop mx-1"><img src="<?php echo e(public_asset('/SPTheme/images/ivao-logo-xs.png')); ?>" alt="IVAO <?php echo app('translator')->get('sptheme.logo'); ?>" width="30" height="30"></a>
               <?php endif; ?>
            </td>
            <?php endif; ?>
            <td class="text-end"><i class="ph-fill ph-trophy align-text-bottom fs-20"></i> <?php echo e($user->awards_count); ?></td>
            <td class="text-end">
               <span class="tooltiptop" title="<?php echo app('translator')->get('sptheme.transferredh'); ?>"><i class="ph-fill ph-clock align-text-bottom fs-20"></i>
                  <?php if(Theme::getSetting('roster_combinetimes')): ?>
                  <?php echo e(\Modules\SPTheme\Services\TimeService::convert($user->flight_time + $user->transfer_time)); ?>

                  <?php else: ?>
                  <?php echo e(\Modules\SPTheme\Services\TimeService::convert($user->flight_time)); ?>
...
</div><?php /**PATH /home/jewe0363/prometheus/resources/views/layouts/SPTheme/users/table.blade.php ENDPATH**/ ?>