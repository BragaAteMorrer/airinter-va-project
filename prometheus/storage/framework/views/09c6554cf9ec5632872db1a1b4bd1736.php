<?php $__env->startSection('title', 'Disposable Basic'); ?>
    ...
    <div class="col-sm-12">
      <div class="col-sm-3">
        <div class="card border-blue-bottom" style="padding:10px;">
          <a href="<?php echo e(route('DBasic.specs')); ?>">Manage ICAO Type, Subfleet or Aircraft Specs</a>
          <br><br>
      ...
      <div class="col-sm-3">
        <div class="card border-blue-bottom" style="padding:10px;">
          <a href="<?php echo e(route('DBasic.tech')); ?>">Manage Maintenance Periods, Pitch, Roll, Flap and Gear Limits</a>
          <br><br>
      ...
      <div class="col-sm-3">
        <div class="card border-blue-bottom" style="padding:10px;">
          <a href="<?php echo e(route('DBasic.runway')); ?>">Manage Runways</a>
          <br><br>
      ...
      <div class="col-sm-3">
        <div class="card border-blue-bottom" style="padding:10px;">
          <a href="<?php echo e(route('DBasic.health_check')); ?>">Database Check</a>
          <br><br>
    ...
    <div class="col-sm-12">
      <div class="col-sm-4">
        <div class="card border-blue-bottom" style="padding:5px;">
          <b>Manual Awarding</b>
          <br>
          <?php echo $__env->make('DBasic::admin.manual_awards', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        </div>
      </div>
      <div class="col-sm-4">
        <div class="card border-blue-bottom" style="padding:5px;">
          <b>Manual Payments</b>
          <br>
          <?php echo $__env->make('DBasic::admin.manual_payment', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
      ...
      <div class="col-sm-4">
        ...
        <div class="card border-blue-bottom" style="padding:5px;">
          ...
          <div style="margin-bottom: 5px;">
            <form class="form" method="post" action="<?php echo e(route('DBasic.park_aircraft')); ?>">
              <?php echo csrf_field(); ?>
    ...
    <div class="col-sm-12">
      <div class="col-sm-7">
        ...
        <div class="card border-blue-bottom" style="padding:5px;">
          <b>Discord</b>
          <br>
          <?php echo $__env->make('DBasic::admin.settings_table', ['group' => 'Discord'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        ...
        <div class="card border-blue-bottom" style="padding:5px;">
          ...
          <br>
          <?php echo $__env->make('DBasic::admin.settings_table', ['group' => 'Network Checks'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        ...
        <div class="card border-blue-bottom" style="padding:5px;">
          <b>API Services</b>
          <br>
          <?php echo $__env->make('DBasic::admin.settings_table', ['group' => 'API Service'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
      ...
      <div class="col-sm-5">
        ...
        <div class="card border-blue-bottom" style="padding:5px;">
          <b>Aircraft</b>
          <br>
          <?php echo $__env->make('DBasic::admin.settings_table', ['group' => 'Aircraft'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        ...
        <div class="card border-blue-bottom" style="padding:5px;">
          ...
          <br>
          <?php echo $__env->make('DBasic::admin.settings_table', ['group' => 'Stable Approach'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        ...
        <div class="card border-blue-bottom" style="padding:5px;">
          ...
          <br>
          <?php echo $__env->make('DBasic::admin.settings_table', ['group' => 'Auto Reject'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        ...
        <div class="card border-blue-bottom" style="padding:5px;">
          ...
          <br>
          <?php echo $__env->make('DBasic::admin.settings_table', ['group' => 'General'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php echo $__env->make('admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/jewe0363/prometheus/modules/DisposableBasic/Providers/../Resources/views/admin/index.blade.php ENDPATH**/ ?>