<?php if($settings): ?>
  <div style="margin-bottom: 5px;">
    <form class="form" method="post" action="<?php echo e(route('DSpecial.save_settings')); ?>">
      <?php echo csrf_field(); ?>
      <table class="table table-borderless table-stiped text-left" style="margin-bottom: 5px;">
        <?php $__currentLoopData = $settings->where('group', $group)->sortBy('order'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $st): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          <tr>
            <td style="width:50%; max-width: 50%;"><?php echo e($st->name); ?></td>
            <td>
...
<?php endif; ?><?php /**PATH /home/jewe0363/prometheus/modules/DisposableSpecial/Providers/../Resources/views/admin/settings_table.blade.php ENDPATH**/ ?>