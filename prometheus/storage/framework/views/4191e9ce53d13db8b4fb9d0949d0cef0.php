          ...
          <tr>
            ...
            <td>
              <?php if($st->field_type === 'check'): ?>
                ...
                <input class="form-control" type="checkbox" name="<?php echo e($st->id); ?>" value="true" <?php if((filled($st->value) && $st->value === 'true') || (blank($st->value) && $st->default === 'true')): ?> checked <?php endif; ?>>
...
<?php endif; ?><?php /**PATH /home/jewe0363/prometheus/modules/DisposableAirports/Providers/../Resources/views/settings_table.blade.php ENDPATH**/ ?>