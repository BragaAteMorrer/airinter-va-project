   ...
   <table class="table table-striped table-hover mb-0">
      ...
      <tbody>
         ...
         <tr class="align-middle">
            ...
            <td class="text-end"> - </td>
            <?php else: ?>
            <td class="text-center"><span class="tooltiptop" title="<?php echo e(optional($p->aircraft)->name); ?>"><?php echo e($p->aircraft->registration); ?> (<?php echo e($p->aircraft->icao); ?>)</span></td>
...
</div><?php /**PATH /home/jewe0363/prometheus/resources/views/layouts/SPTheme/pireps/table.blade.php ENDPATH**/ ?>