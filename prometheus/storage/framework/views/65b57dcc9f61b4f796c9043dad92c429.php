<?php $__env->startSection('scripts'); ?>
  <script>
    function setEditable() {
      ...
      <?php if(isset($subfleet)): ?>
      $('#aircraft_fares a').editable({
        type: 'text',
        mode: 'inline',
        emptytext: 'inherited',
        url: '<?php echo e(url('/admin/subfleets/'.$subfleet->id.'/fares')); ?>',
      ...
      $('#subfleet_ranks a').editable({
        ...
        mode: 'inline',
        emptytext: 'inherited',
        url: '<?php echo e(url('/admin/subfleets/'.$subfleet->id.'/ranks')); ?>',
        title: 'Enter override value',
        ajaxOptions: {
          type: 'post',
          headers: {
      ...
      $('#subfleet-expenses a.text').editable({
        emptytext: '0',
        url: '<?php echo e(url('/admin/subfleets/'.$subfleet->id.'/expenses')); ?>',
        title: 'Enter override value',
        ajaxOptions: {
          type: 'post',
          headers: {
...
<?php /**PATH /home/jewe0363/prometheus/resources/views/admin/subfleets/script.blade.php ENDPATH**/ ?>