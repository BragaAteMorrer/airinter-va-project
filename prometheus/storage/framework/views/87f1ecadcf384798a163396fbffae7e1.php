                ...
                document.querySelectorAll("button.save_flight").forEach(button => {
                    button.addEventListener('click', function(e) {
                        ...
                        if (!btn.classList.contains(class_name)) {
                            ...
                            fetch(`<?php echo e(Config::get('app.url')); ?>/api/flights/${flight_id}/aircraft`, {
                                    headers: {
...
<?php /**PATH /home/jewe0363/prometheus/resources/views/layouts/SPTheme/flights/scripts.blade.php ENDPATH**/ ?>