<div id="subfleet-expenses-wrapper" class="col-12">
  ...
  <table class="table table-responsive" id="subfleet-expenses">
    <?php if(count($subfleet->expenses)): ?>
      <thead>
      <th>Name</th>
      <th>Cost&nbsp;<span class="small"><?php echo e(currency(setting('units.currency', 'USD'))); ?></span></th>
      <th>Type</th>
      <th></th>
      </thead>
    <?php endif; ?>
    <tbody>
    <?php $__currentLoopData = $subfleet->expenses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $expense): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
      <tr>
        <td>
          <p>
        ...
        <td align="right">
          <?php echo e(Form::open(['url' => url('/admin/subfleets/'.$subfleet->id.'/expenses'),
  ...
  <div class="row">
    <div class="col-sm-12">
      <div class="text-right">
        ...
        <?php echo e(Form::text('name', null, ['class' => 'form-control input-sm', 'placeholder' => 'Name'])); ?>
...
<?php /**PATH /home/jewe0363/prometheus/resources/views/admin/subfleets/expenses.blade.php ENDPATH**/ ?>