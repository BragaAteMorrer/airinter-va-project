      ...
      <div class="card border mb-3">
         <div class="card-body">
            <h4 class="mt-0 header-title border-bottom">
               <i class="ph-fill ph-books align-middle fs-20 me-1"></i><?php echo app('translator')->get('dashboard.recentreports'); ?>
               <a class="btn btn-primary float-end" href="<?php echo e(route('frontend.pireps.create')); ?>"><?php echo app('translator')->get('pireps.filenewpirep'); ?></a>
            </h4>
            ...
            <?php if($pireps->count()): ?>
               <?php echo $__env->make('pireps.table', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            <?php else: ?>
...
<?php echo $__env->make('app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/jewe0363/prometheus/resources/views/layouts/SPTheme/pireps/index.blade.php ENDPATH**/ ?>